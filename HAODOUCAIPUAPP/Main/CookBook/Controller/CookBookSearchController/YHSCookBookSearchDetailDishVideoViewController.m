...
//
//  YHSCookBookSearchDetailDishVideoViewController.m
//  HAODOUCAIPUAPP
//
...
@implementation YHSCookBookSearchDetailDishVideoViewController


- (NSString *)getCookBookDishVedioRequestURLString
{
    // 默认主页面内容，子类必须继承
    return [YHSCookBookDataUtil getCookBookSearchDetailDishVideoRequestURLString];
}

- (NSMutableDictionary *)getCookBookDishVedioRequestParams
{
    // 默认主页面内容，子类必须继承
    NSMutableDictionary *params = [YHSCookBookDataUtil getCookBookSearchDetailDishVideoRequestParams];
