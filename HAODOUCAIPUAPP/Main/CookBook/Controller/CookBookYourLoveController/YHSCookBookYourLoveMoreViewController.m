//
//  YHSCookBookYourLoveMoreViewController.m
//  HAODOUCAIPUAPP
//
...
@interface YHSCookBookYourLoveMoreViewController () <UITableViewDelegate, UITableViewDataSource, YHSCookBookYourLoveMoreTableViewCellDelegate>
...
@property (nonatomic, strong) NSMutableArray<YHSCookBookYourLoveMoreModel *> *tableData;
...
@implementation YHSCookBookYourLoveMoreViewController
...
- (void)createUITable
{
    ...
    // 创建表格
    {
        ...
        [self.tableView registerClass:[YHSCookBookYourLoveMoreTableViewCell class] forCellReuseIdentifier:CELL_IDENTIFIER_YOUR_LOVE_MORE];
...
- (void)loadDataThen:(void (^)(BOOL success, NSUInteger count))then andWritingLoading:(BOOL)showWritingLoading {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        // 请求地址与参数
        NSString *url = [YHSCookBookDataUtil getYourLoveHeaderSectionRequestURLString];
        NSMutableDictionary *params = [YHSCookBookDataUtil getYourLoveHeaderSectionRequestParams];
        ...
        [manager GET:url parameters:params progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            // 数据模型转换
            NSMutableArray<YHSCookBookYourLoveMoreModel *> *models = [NSMutableArray array];
            [list enumerateObjectsUsingBlock:^(NSDictionary *  _Nonnull dict, NSUInteger idx, BOOL * _Nonnull stop) {
                YHSCookBookYourLoveMoreModel *model = [YHSCookBookYourLoveMoreModel mj_objectWithKeyValues:dict];
...
#pragma mark - 触发点击图片事件
- (void)didClickElementOfCellWithYourLoveMoreModel:(YHSCookBookYourLoveMoreModel *)model
{
    // 菜谱详情界面
    if (model.HasVideo) {
        // 视屏菜谱
        YHSCookBookYourLoveDishVideoViewController *dishVedioViewController = [YHSCookBookYourLoveDishVideoViewController new];
        ...
        // 图片菜谱
        YHSCookBookYourLoveDishPictureViewController *dishVedioViewController = [YHSCookBookYourLoveDishPictureViewController new];
        [dishVedioViewController setRid:[NSString stringWithFormat:@"%ld", model.RecipeId]];
        [dishVedioViewController setReturn_request_id:@""];
        [dishVedioViewController setTitle:@" "];
        [self.navigationController pushViewController:dishVedioViewController animated:YES];
...
- (void)didClickElementOfCellWithYourLoveMoreTagModel:(YHSCookBookYourLoveMoreTagModel *)model
{
    ...
    [searchResultController setScene:@"k2"];
...
- (void)didClickElementOfCellLikeCountWithYourLoveMoreModel:(YHSCookBookYourLoveMoreTagModel *)model
{
    // 提示信息
...
{
    YHSCookBookYourLoveMoreTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CELL_IDENTIFIER_YOUR_LOVE_MORE];
    if (!cell) {
        cell = [[YHSCookBookYourLoveMoreTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CELL_IDENTIFIER_YOUR_LOVE_MORE];
    }
    cell.delegate = self;
