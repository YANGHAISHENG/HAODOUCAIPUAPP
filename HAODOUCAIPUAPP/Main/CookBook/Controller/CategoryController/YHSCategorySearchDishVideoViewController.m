//
//  YHSCategorySearchDishVedioViewController.m
//  HAODOUCAIPUAPP
//
...
@implementation YHSCategorySearchDishVideoViewController

- (NSString *)getCookBookDishVedioRequestURLString
{
    // 默认主页面内容，子类必须继承
    return [YHSCookBookDataUtil getCategoryDishVideoRequestURLString];
}

- (NSMutableDictionary *)getCookBookDishVedioRequestParams
{
    // 默认主页面内容，子类必须继承
    NSMutableDictionary *params = [YHSCookBookDataUtil getCategoryDishVideoRequestParams];
