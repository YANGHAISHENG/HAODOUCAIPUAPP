//
//  YHSCookBookShakeItOffDetailDishPictureViewController.m
//  HAODOUCAIPUAPP
//
...
@implementation YHSCookBookShakeItOffDetailDishPictureViewController

- (NSString *)getCookBookDishVedioRequestURLString
{
    // 默认主页面内容，子类必须继承
    return [YHSCookBookDataUtil getCookBookShakeItOffDishPictureRequestURLString];
}

- (NSMutableDictionary *)getCookBookDishVedioRequestParams
{
    // 默认主页面内容，子类必须继承
    NSMutableDictionary *params = [YHSCookBookDataUtil getCookBookShakeItOffDishPictureRequestParams];
