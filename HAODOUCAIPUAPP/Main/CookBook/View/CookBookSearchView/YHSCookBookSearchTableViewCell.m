//
//  YHSCookBookSearchTableViewCell.m
//  HAODOUCAIPUAPP
//
...
@implementation YHSCookBookSearchTableViewCell
...
- (void)setViewAtuoLayout{
    ...
    [self.coverImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(weakSelf.publicContainerView.mas_centerY);
...
- (void)setModel:(YHSCookBookSearchModel *)model
{
    ...
    // 图片
    [_coverImageView setImage:[UIImage imageNamed:@"search_suggest"]];
...
- (void)pressPublicContainerArea:(UITapGestureRecognizer *)gesture
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(didClickElementOfCellWithCookBookSearchModel:)]) {
        [self.searchDelegate didClickElementOfCellWithCookBookSearchModel:self.model];
    }
