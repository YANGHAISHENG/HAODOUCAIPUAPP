//
//  YHSBasicScrollTabBarViewController.m
//  HAODOUCAIPUAPP
//
...
#import "YHSBasicScrollTabBarViewController.h"

@interface YHSBasicScrollTabBarViewController ()

@property (nonatomic, copy) NSMutableArray<__kindof UIViewController *> *scrollViewControllers;

@end

@implementation YHSBasicScrollTabBarViewController
...
- (void)viewDidLoad
{
    ...
    // 设置
    [self setViewControllers:[NSArray arrayWithArray:self.scrollViewControllers]];
}
               ...
               tabBarSelectImageName:(NSString *)selectName
{
    ...
    // 主标签控制器中添加子导航控制器
    [self.scrollViewControllers addObject:naviViewController];
}
...
- (NSMutableArray<__kindof UIViewController *> *)scrollViewControllers
{
    if (_scrollViewControllers == nil) {
        _scrollViewControllers = [NSMutableArray array];
    }
    return _scrollViewControllers;
}
