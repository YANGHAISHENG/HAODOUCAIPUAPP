...
@implementation YHSHandWritingLoadingView
...
{
    // Loading Shape
    UIBezierPath *loadingBezierpath = [YHSHandWritingLoadingView loadingShapeBezierPath];
    ...
    _loadingShapeLayer.strokeColor = [UIColor colorWithRed:0.95 green:0.63 blue:0.15 alpha:1.00].CGColor;
    ...
    // Dot Shape
    UIBezierPath *dotBezierPath = [YHSHandWritingLoadingView dotShapeBezierPath];
    ...
    _dotShapeLayer.strokeColor = [UIColor colorWithRed:0.95 green:0.63 blue:0.15 alpha:1.00].CGColor;
...
- (void) initAnimation
{
    ...
    _dotKeyframeAnimation.duration = 2.0f;
